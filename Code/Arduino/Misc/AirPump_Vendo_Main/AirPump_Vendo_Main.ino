/*******************************************************
 * Project: AirPump Vendo
 * Board: ESP32 Dev Module (ESP32-WROOM)
 *
 * Description:
 *   AirPump Vendo is an automated vending system 
 *   powered by ESP32. It is configured for maximum 
 *   performance with a 240 MHz CPU frequency and a 
 *   Huge APP partition scheme, providing ample space 
 *   for program storage. The system is designed to 
 *   handle real-time control and communication tasks.
 *
 ...
 *
 * Notes:
 *   - Optimized for large applications due to Huge APP 
 *     partition scheme.
 *   - High upload speed ensures faster development cycles.
 *******************************************************/
#include <lvgl.h>
#include <TFT_eSPI.h>
